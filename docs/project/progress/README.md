...
| CP2 Renderer Registry 与运行时收敛 | 已完成 | 2026-08-21 | [CP2-01 v2 双试点运行链路](CP2-01-renderer-registry-and-v2-pilot-runtime.md)；[CP2-02 正式对话课与词汇课迁移](CP2-02-formal-dialogue-vocabulary-migration.md)；[CP2-03 检查点迁移与运行时收束](CP2-03-checkpoint-v2-migration-and-runtime-consolidation.md) |
| CP3 语音与拼音课程体系 | 待开始 | - | - |
...
| CP2-03 检查点 v2 迁移与运行时收束 | 已完成 | 2026-08-21 | [CP2-03 开发进度](CP2-03-checkpoint-v2-migration-and-runtime-consolidation.md) |
